...
import moh.fa2021.cse201f.g4.appcatalogdemo.filters.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public RoleHierarchy roleHierarchy() {
        ...
        r.setHierarchy("ADMIN>MODERATOR\n" +
                "MODERATOR>STANDARD");
        return r;
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/auth/*", "/guest/*").permitAll().anyRequest().authenticated()
